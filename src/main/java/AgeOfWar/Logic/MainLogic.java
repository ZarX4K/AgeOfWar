...
public class MainLogic implements Runnable {
    ...
    private void spawnTank() {
        Tank tank = new Tank(150, 800, 150, 150, "Tank.png", "Tank.png", "Tank.png", 170, 25, 120, 1, true, false, false, false, 30, 20, 5);
    ...
    private void spawnEnemyTank() {
        Tank enemyTank = new Tank(1400, 800, 150, 150, "enemyTank.png", "enemyTank.png", "enemyTank.png", 170, 25, 120, 1, true, true, false, false, 30, 5, 5);
